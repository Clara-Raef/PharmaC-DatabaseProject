...
lbl_bg=Label(rt,image=bg).place(x=0,y=0,relwidth=1,relheight=1)
               
frame=Frame(rt,bg="white", highlightbackground="dark slate gray", highlightthickness="10")
...
username=Label(frame,text="Username",font=("Goudy old style",15,"bold"),fg="gray",bg="white")
...
txtpass=Entry(frame,font=("times new roman",15),bg="lightgray", show="*")
...
lblimg1.place(x=247,y=300,width=25,height=25)
img3=Image.open("passwordpic.png")
img3=img3.resize((25,25),Image.ANTIALIAS)
photoimage3=ImageTk.PhotoImage(img3)
lblimg2=Label(image=photoimage3,bg="white",borderwidth=0).place(x=247,y=373,width=25,height=25)
